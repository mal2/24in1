...
RemoveHTML(htmlcode)
	{
			htmlCode := RegExReplace(htmlCode, "s)(?://\s*)?<!--.+?(?://\s*)?-->", "") ; Remove comments, including scripts
			htmlCode := RegExReplace(htmlCode, "s)(?://\s*)?<!\[CDATA\[.+?(?://\s*)?\]\]>", "") ; Remove CDATA, mostly scripts
			htmlCode := RegExReplace(htmlCode, "s)<.+?>", "")      ; Removes tags
			htmlCode := RegExReplace(htmlCode, "[ \t]+", " ")      ; Collapses spaces
			htmlCode := RegExReplace(htmlCode, "[\r\n]+", "`n")    ; Removes multiple new lines
			htmlCode := RegExReplace(htmlCode, "&nbsp;", "")    ; Removes multiple new lines
			htmlCode := RegExReplace(htmlCode, """", "")    ; Removes multiple new lines
			Return htmlcode
	}
	
/* li := ComObjCreate("InternetExplorer.Application")
 * li.Visible := True
 * li.Navigate("https://wikis.fu-berlin.de/Shibboleth.sso/Login?target=http://wikis.fu-berlin.de/homepage.action")
 * Sleep, 1000
 */
...
; Altbau
wb.Navigate("http://wikis.fu-berlin.de/pages/viewpage.action?pageId=649602364")
While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   Sleep 300

get = <table class="confluenceTable tablesorter">
table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
msgbox, % table
altbau := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
FileAppend,%altbau%, C:\Users\xandir\web\dienstplan\altbau

;~ ; Auskunft
;~ wb.Navigate("http://wikis.fu-berlin.de/pages/viewpage.action?pageId=649595701")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Auskunft1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft1%, C:\Users\xandir\web\dienstplan\Auskunft1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Auskunft2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft2%, C:\Users\xandir\web\dienstplan\Auskunft2
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,3)
;~ Auskunft3 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft3%, C:\Users\xandir\web\dienstplan\Auskunft3
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,4)
;~ Auskunft4 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft4%, C:\Users\xandir\web\dienstplan\Auskunft4
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,5)
;~ Auskunft5 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft5%, C:\Users\xandir\web\dienstplan\Auskunft5
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,6)
;~ Auskunft6 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Auskunft6%, C:\Users\xandir\web\dienstplan\Auskunft6


;~ ; Einstelldienst
;~ wb.Navigate("http://wikis.fu-berlin.de/display/24in1/Dienstplan+Einstelldienst+Umzug+-alt")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Einstelldienst1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst1%, C:\Users\xandir\web\dienstplan\Einstelldienst1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Einstelldienst2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst2%, C:\Users\xandir\web\dienstplan\Einstelldienst2
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,3)
;~ Einstelldienst3 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst3%, C:\Users\xandir\web\dienstplan\Einstelldienst3
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,4)
;~ Einstelldienst4 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst4%, C:\Users\xandir\web\dienstplan\Einstelldienst4
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,5)
;~ Einstelldienst5 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst5%, C:\Users\xandir\web\dienstplan\Einstelldienst5
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,6)
;~ Einstelldienst6 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Einstelldienst6%, C:\Users\xandir\web\dienstplan\Einstelldienst6

;~ ; Pausenraum Umzug
;~ wb.Navigate("http://wikis.fu-berlin.de/display/24in1/Dienstplan+Pausenraum+Umzug")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Pausenraum1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum1%, C:\Users\xandir\web\dienstplan\Pausenraum1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Pausenraum2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum2%, C:\Users\xandir\web\dienstplan\Pausenraum2
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,3)
;~ Pausenraum3 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum3%, C:\Users\xandir\web\dienstplan\Pausenraum3
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,4)
;~ Pausenraum4 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum4%, C:\Users\xandir\web\dienstplan\Pausenraum4
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,5)
;~ Pausenraum5 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum5%, C:\Users\xandir\web\dienstplan\Pausenraum5
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,6)
;~ Pausenraum6 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Pausenraum6%, C:\Users\xandir\web\dienstplan\Pausenraum6


;~ ; Springer
;~ wb.Navigate("http://wikis.fu-berlin.de/display/24in1/Dienstplan+Springer")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Springer1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer1%, C:\Users\xandir\web\dienstplan\Springer1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Springer2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer2%, C:\Users\xandir\web\dienstplan\Springer2
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,3)
;~ Springer3 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer3%, C:\Users\xandir\web\dienstplan\Springer3
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,4)
;~ Springer4 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer4%, C:\Users\xandir\web\dienstplan\Springer4
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,5)
;~ Springer5 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer5%, C:\Users\xandir\web\dienstplan\Springer5
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,6)
;~ Springer6 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Springer6%, C:\Users\xandir\web\dienstplan\Springer6


;~ ; Stellrevision
;~ wb.Navigate("http://wikis.fu-berlin.de/display/24in1/Dienstplan+Stellrevision+Neubau")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Stellrevision1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision1%, C:\Users\xandir\web\dienstplan\Stellrevision1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Stellrevision2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision2%, C:\Users\xandir\web\dienstplan\Stellrevision2
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,3)
;~ Stellrevision3 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision3%, C:\Users\xandir\web\dienstplan\Stellrevision3
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,4)
;~ Stellrevision4 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision4%, C:\Users\xandir\web\dienstplan\Stellrevision4
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,5)
;~ Stellrevision5 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision5%, C:\Users\xandir\web\dienstplan\Stellrevision5
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,6)
;~ Stellrevision6 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Stellrevision6%, C:\Users\xandir\web\dienstplan\Stellrevision6


;~ ; Tuerwaechter
;~ wb.Navigate("http://wikis.fu-berlin.de/pages/viewpage.action?pageId=649604957")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Tuerwaechter1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Tuerwaechter1%, C:\Users\xandir\web\dienstplan\Tuerwaechter1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Tuerwaechter2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Tuerwaechter2%, C:\Users\xandir\web\dienstplan\Tuerwaechter2


;~ ; Fahrstuhlwaechter
;~ wb.Navigate("http://wikis.fu-berlin.de/pages/viewpage.action?pageId=649600680")
;~ While wb.readyState !=4 || wb.document.readyState !="complete" || wb.busy  ;wait for page to fully load
   ;~ Sleep 300

;~ get = <table class="confluenceTable tablesorter">
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,1)
;~ Fahrstuhlwaechter1 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Fahrstuhlwaechter1%, C:\Users\xandir\web\dienstplan\Fahrstuhlwaechter1
;~ table := GetNestedTag(wb.document.documentelement.outerhtml,get,2)
;~ Fahrstuhlwaechter2 := RemoveHTML(Table_ToCSV(Table_FromHTML(table)))
;~ FileAppend,%Fahrstuhlwaechter2%, C:\Users\xandir\web\dienstplan\Fahrstuhlwaechter2
;~ Return